 ...
 * - Die Aufgaben.String-Methoden `indexOf()` oder `startsWith()` könnten hilfreich sein.
 *
 */
class SS_I_CountOccurence__WieOftSInS {
    ...
    /*
        public static Integer countOccurences(Aufgaben.String a, Aufgaben.String s) {
