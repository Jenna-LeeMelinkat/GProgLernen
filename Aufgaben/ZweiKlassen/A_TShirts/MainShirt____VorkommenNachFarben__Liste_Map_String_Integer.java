 ...
 * ## Shirts
 * 
 * Gegeben sei die Klasse `Aufgaben.ZweiKlassen.TShirts.Shirt`. Ein Aufgaben.ZweiKlassen.TShirts.Shirt hat
 * 
 * - eine Größe (XS, S, M, L, XL, etc.),
 * - und eine Farbe ("rot", "grün", "blau", "gelb", etc.).
 * 
 * Wie `Aufgaben.ZweiKlassen.TShirts.Shirt`s angelegt und ausgegeben werden können,
 * lässt sich den Beispielen in der `main()`-Methode entnehmen.
 * Es ist ferner eine Methode `factory()` gegeben, die eine Liste von
 * *n* zufälligen `Aufgaben.ZweiKlassen.TShirts.Shirt`s erzeugen kann.
 * 
 * 1. Ergänzen Sie die gegebene Klasse `Aufgaben.ZweiKlassen.TShirts.Shirt` gem. Java-Konventionen so,
 ...
 *    die es erlauben aus `Aufgaben.ZweiKlassen.TShirts.Shirt`-Objekten Farbe und Größe auszulesen.
 * 3. Entwickeln Sie ferner eine Methode `countColors()`,
 *    die zählt, wie viele `Aufgaben.ZweiKlassen.TShirts.Shirt`s einer Farbe in einer Aufgaben.Arrais.List von `Aufgaben.ZweiKlassen.TShirts.Shirt`s vorkommen.
 * 
...
class MainShirt____VorkommenNachFarben__Liste_Map_String_Integer {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s1); // => "rotes XS-Aufgaben.ZweiKlassen.TShirts.Shirt"
        System.out.println(s2); // => "grünes L-Aufgaben.ZweiKlassen.TShirts.Shirt"
