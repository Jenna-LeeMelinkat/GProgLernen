 ...
 * Kombinationen als Liste von `Aufgaben.ZweiKlassen.TupleListen.Tuple`n erzeugt.
 *
 * Auch die Klasse `Aufgaben.ZweiKlassen.TupleListen.Tuple` inkl. Konstruktor und `toString()`-
 *`Methode ist durch Sie zu entwickeln.
 *
 * Aufrufbeispiele zur Erzeugung von `Aufgaben.ZweiKlassen.TupleListen.Tuple`n und
