...
public class Evaluate_StringAusrechnen {
     ...
     * (wie bspw. 42) und die Grundrechenarten-Operatoren +, -,
     * ungeklammert abwechselnd aufeinander folgen. Operatoren **können** von Zahlen durch ein oder mehrere Leerzeichen getrennt sein.
     * Also z.B. So *"1 + 2 * 3 / 4"* oder so *"5-4*3+2/1"* (auch Mischformen sind zulässig). derartigen eichenketten une mettere usalute), den
     * die Operatoren in der üblichen Infix-Notation von links nach rechts abgearbeitet werden.
     * Es ist sichergestellt, dass Zeichenketten immer nur positive natürliche Zahlen inkl. der Null und die genannten Operatoren
     ...
     * an die zu verarbeitenden Dezimalwerte und Operatoren zu gelangen,
